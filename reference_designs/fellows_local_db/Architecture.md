...
> **Post-L1/L2 note (v0.2).** PNT's L1/L2 layering pass retired `AC-3 / AC-12 / AC-13 / AC-14` from the AC namespace into the Layer-2 **realization** family — they are now `RZ-1 / RZ-2 / RZ-3 / RZ-4` in [spec/axes.md](https://github.com/richbodo/personal_network_toolkit/blob/main/spec/axes.md#retired-ids-redirects) (the old IDs survive there as redirect anchors). They are retained in this table under their legacy IDs for traceability rather than relabeled. In particular **RZ-2** (former AC-12) is fellows's realization of the new universal **AC-22** above; **RZ-1 / RZ-3 / RZ-4** realize **AC-1** (and AC-11).
